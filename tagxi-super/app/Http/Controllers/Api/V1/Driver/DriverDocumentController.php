    ...
    */
    ...
    {   
        ...
        if(auth()->user()->driver->owner_id){
            $driverneededdocumentQuery  = DriverNeededDocument::where('account_type','fleet_driver')->orWhere('account_type', 'both')->active()->get();
        }else{

        $driverneededdocumentQuery  = DriverNeededDocument::where('account_type','individual')->orWhere('account_type', 'both')->active()->get();
