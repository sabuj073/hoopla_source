...
//base url
String url =
    'https://hoopla.cab/'; //add '/' at the end of the url as 'https://yourwebsite.com/'
String mapkey = 'AIzaSyCTUwvo2F9UTFvJi56E0MPxukuI1ZsRvPY';
String mapStyle = '';
...
geolocs.LocationSettings locationSettings = (platform == TargetPlatform.android)
    ? geolocs.AndroidSettings(
        ...
        foregroundNotificationConfig:
          ...
          notificationText:
              "Hoopla Driver will continue to receive your location in background",
